...
namespace AutoReservation.Service.Wcf
{
    public static class DtoConverter
    {
        ...
        public static AutoDto ConvertToDto(this Auto auto)
        {
            ...
            var dto = new AutoDto {Id = auto.Id, Marke = auto.Marke, Tagestarif = auto.Tagestarif,};
        ...
        public static Kunde ConvertToEntity(this KundeDto dto)
        {
            ...
            return new Kunde
                   {Id = dto.Id, Nachname = dto.Nachname, Vorname = dto.Vorname, Geburtsdatum = dto.Geburtsdatum};
        }
        ...
        public static KundeDto ConvertToDto(this Kunde kunde)
        {
            ...
            return new KundeDto
                   {
                       Id = kunde.Id, Nachname = kunde.Nachname, Vorname = kunde.Vorname, Geburtsdatum = kunde.Geburtsdatum
                   };
        }
        ...
        public static ReservationDto ConvertToDto(this Reservation reservation)
        {
            ...
            return new ReservationDto
                   {
                       ReservationNr = reservation.ReservationNr, Von = reservation.Von, Bis = reservation.Bis,
                       Auto = ConvertToDto(reservation.Auto), Kunde = ConvertToDto(reservation.Kunde)
                   };
        }
