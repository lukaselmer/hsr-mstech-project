...
namespace AutoReservation.Testing
{
    public static class TestEnvironmentHelper
    {
        private const string ConnectionString =
            "Data Source=localhost\\SQLEXPRESS;Initial Catalog=AutoReservation;Integrated Security=True";
        ...
        private static void InsertKunden()
        {
            using (var myConnection = new SqlConnection(ConnectionString))
            {
                ...
                myCommand.CommandText =
                    "INSERT INTO Kunde (Nachname, Vorname, Geburtsdatum) VALUES ('Nass', 'Anna', '05/05/1961')";
                myCommand.ExecuteNonQuery();

                myCommand.CommandText =
                    "INSERT INTO Kunde (Nachname, Vorname, Geburtsdatum) VALUES ('Beil', 'Timo', '09/09/1980')";
                myCommand.ExecuteNonQuery();

                myCommand.CommandText =
                    "INSERT INTO Kunde (Nachname, Vorname, Geburtsdatum) VALUES ('Pfahl', 'Martha', '07/03/1950')";
                myCommand.ExecuteNonQuery();

                myCommand.CommandText =
                    "INSERT INTO Kunde (Nachname, Vorname, Geburtsdatum) VALUES ('Zufall', 'Rainer', '11/11/1944')";
                myCommand.ExecuteNonQuery();
            }
        }
        ...
        private static void InsertReservationen()
        {
            using (var myConnection = new SqlConnection(ConnectionString))
            {
                ...
                myCommand.CommandText = "INSERT INTO Reservation (AutoId, KundeId, Von, Bis)  " +
                    "   SELECT  a.Id  , k.Id, '1/10/2020', '1/20/2020' " + "   FROM    Auto a, Kunde k " +
